...
$mail->Subject = "Konfirmasi Edit Akun"; //subyek email
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style='border-bottom:1px solid #f6f6f6;'>
                                ...
                                <p style='margin-top:0px; color:#bbbbbb;'>Email Konfirmasi Melakukan Penyuntingan Akun, mohon untuk
                                    tidak membalas.</p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style='padding:10px 0 30px 0;'>
                                ...
                                <p>
                                    Benar Anda melakukan ini?. Anda telah melakukan perubahan pada Akun Anda, Jika ingin mengkonfirmasi perubahan ini Anda dapat klik tombol di bawah ini :
                                </p>
                                <center>
                                    <a href='".$link."dashboard/profile/index.php?konfir=".$kunci."&&e=".$email."&&p=".$pass."&&n=".$phone."'
                        ...
                        <tr>
                            <td style='border-top:1px solid #f6f6f6; padding-top:20px; color:#777'>Jika
                                Anda terus
                                mengalami
...
if($mail->Send()){
    setcookie('berhasil','Satu langkah lagi, Periksa Email Anda dan Konfirmasi',time()+2);
